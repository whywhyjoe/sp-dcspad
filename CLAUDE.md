...
src/workbench/            SP Workbench, a site inspector (read + Tier 2 edit tools):
                          ...
                          standardized metadata block) plus the bulk-bundle
                          helpers (folder-mirroring entry names, collision
                          de-dup, the in-zip export report) ·
                          ...
                          mockWriter) ·
                          grid.js sort/filter/export/copy-as, row selection (selection-scoped exports), column resizers + render cells, createMenuButton (Export ▾ style menus) ·
                          ...
                          parts/Raw, plus the selected-pages content .zip —
