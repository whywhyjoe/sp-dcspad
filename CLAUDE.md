...
src/sp-files.js           SharePoint document-library text transfer (digest cache,
                          same-tenant site switching, forced-check-out probe +
                          CheckOut() ahead of an overwrite)
...
src/workbench/            SP Workbench, a site inspector (read + Tier 2 edit tools):
                          ...
                          folder AddUsingPath, CheckOut() for forced-check-out
                          libraries, mock writer recording to
