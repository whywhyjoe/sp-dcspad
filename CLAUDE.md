...
src/workbench/            SP Workbench, a site inspector (read + Tier 2 edit tools):
                          ...
                          builders (pure; text parts sanitized then converted to
                          markdown, falling back to HTML only where markdown
                          cannot carry the part; location line, merged content,
