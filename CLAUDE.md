...
src/workbench/            SP Workbench, a site inspector (read + Tier 2 edit tools):
                          ...
                          library kind 119/850/titled — a web can carry more
                          than one pages library and the Pages view offers a
                          picker; per-item page kind from
