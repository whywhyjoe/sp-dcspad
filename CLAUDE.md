...
src/workbench/            SP Workbench, a site inspector (read + Tier 2 edit tools):
                          ...
                          for checked-out files, mock writer recording to
                          ...
                          grid.js sort/filter/export/copy-as, row selection (selection-scoped exports), column resizers + render cells ·
